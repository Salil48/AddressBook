namespace AddressBookSystem
{
    class AddressBookSystems
    {
        ...
        public string email;
        public AddressBookSystems[] ContactArray;
        int contact = 0;

        //Parameterised Constructor
        public AddressBookSystems(string firstName, string lastName, string Address, string city, string state, int zip, long phoneNumber, string email)
        {
        ...
        //Default Contructor
        public AddressBookSystems()
        {
            this.ContactArray = new AddressBookSystems[10];
        }
        ...
        public void CreateContact(string firstName, string lastName, string Address, string city, string state, int zip, long phoneNumber, string email)
        {
            ...
            ContactArray[this.contact] = new AddressBookSystems(firstName, lastName, Address, city, state, zip, phoneNumber, email);
            contact++;
