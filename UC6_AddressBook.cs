...
namespace AddressBookSystem
{
    public class UC6_AddressBook
    {
        public static void Main(string[] args)
        {
            ...
            IDictionary<string, AddressBookSystems[]> numberNames = new Dictionary<string, AddressBookSystems[]>();
            ...
            while (i < num)
            {
                ...
                AddressBookSystems addressBookSystem = new AddressBookSystems();
                ...
                foreach (KeyValuePair<string, AddressBookSystems[]> kvp in numberNames)
                {
        ...
        //Display Details
        public void Display(AddressBookSystems[] ContactArray, int N)
        {
